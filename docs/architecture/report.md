...
Учитывая, что приложение не хранит видеофайлы, а только агрегирует данные и ссылки, оптимальным решением будет контейнеризация (Docker) с разделением на независимые узлы:
